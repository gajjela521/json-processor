...
import { generateTypeScriptInterfaces, generateZodSchema, generateJavaPOJO, generateSqlDDL, generateMongooseSchema } from './generators';
    ...
    describe('Generators', () => {
        ...
        describe('generateMongooseSchema', () => {
            it('should generate valid Mongoose schema', () => {
                const result = generateMongooseSchema(sampleJson, 'UserSchema');
                expect(result).toContain("import mongoose, { Schema } from 'mongoose';");
